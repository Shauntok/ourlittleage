    ...
    <main className="min-h-screen overflow-x-hidden bg-black px-5 py-20 text-white md:px-6 md:py-24">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        {initialPosts.length === 0 && (
          <div className="rounded-[2.2rem] border border-white/10 bg-white/[0.03] p-10 text-center backdrop-blur-2xl md:rounded-[2.8rem] md:p-16">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <p className="safe-pre mt-6 max-w-3xl text-[15px] leading-[2.15] text-white/42 md:mt-7">
                    {excerpt}
